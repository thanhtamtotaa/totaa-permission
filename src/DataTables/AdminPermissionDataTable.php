        ...
        return datatables()
            ...
            ->addColumn('action', function ($query) {
                ...
                if (Auth::user()->bfo_info->can("edit-permission")) {
                    $Action_Icon.="<div class='col action-icon-w-50 action-icon' totaa-edit-permission='$query->id'><i class='text-indigo fas fa-edit'></i></div>";
                }

                if (Auth::user()->bfo_info->can("delete-permission")) {
                    $Action_Icon.="<div class='col action-icon-w-50 action-icon' totaa-delete-permission='$query->id'><i class='text-danger fas fa-trash-alt'></i></div>";
                }
